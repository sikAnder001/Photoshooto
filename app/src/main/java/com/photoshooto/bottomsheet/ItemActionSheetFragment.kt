...
import com.photoshooto.databinding.ItemActionSheetBinding
...
class ItemActionSheetFragment : BottomSheetDialogFragment() {
    lateinit var binding: ItemActionSheetBinding
    ...
    override fun onCreateView(
        ...
        binding = ItemActionSheetBinding.inflate(inflater, container, false)
    ...
    companion object {
        ...
        fun newInstance(
            ...
            onTap: (String) -> Unit = {},
        ): ItemActionSheetFragment {

            val f = ItemActionSheetFragment()
