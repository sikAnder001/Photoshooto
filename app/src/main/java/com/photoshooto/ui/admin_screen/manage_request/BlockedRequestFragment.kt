...
import com.photoshooto.databinding.FragmentBlockedRequestBinding
...
class BlockedRequestFragment : Fragment() {

    private lateinit var binding: FragmentBlockedRequestBinding
    ...
    private fun initObserver() {
        with(viewModel) {
            blockedRequestResponse.observe(
                requireActivity(),
                Observer { result ->
                    result.success?.let {
                        if (it) {
                                        ...
                                        when (page) {
                                            0 -> {
                                                recyclerView.adapter =
                                                    RejectedRequestAdapter(it as ArrayList, true)
                                                    ...
                                                    object :
                                                        ...
                                                        override fun onDetailsClick(
                                                            ...
                                                            findNavController().navigate(
                                                                BlockedRequestFragmentDirections.actionMoveToUserDetails(
    ...
    override fun onCreateView(
        ...
        binding = FragmentBlockedRequestBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun callRequestApi(isResetPage: Boolean = false) {
        ...
        viewModel.getBlockedRequestUser(
            page,
