...
import com.photoshooto.databinding.FragmentPhotographerAddAddressBinding
...
class PhotographerAddAddressFragment : Fragment() {
    ...
    private lateinit var binding: FragmentPhotographerAddAddressBinding
        ...
        viewModel.apply {
            addAddressResponse.observe(
                ...
                Observer { result ->
                    result.success?.let {
                        if (it) {
                            this@PhotographerAddAddressFragment.setFragmentResult(
                                REQUEST_ADD_EDIT_ADDRESS, bundleOf(
    ...
    override fun onCreateView(
        ...
        binding = FragmentPhotographerAddAddressBinding.inflate(inflater, container, false)
            ...
            edtState.setOnClickListener {
                viewModel.getStatesResponse.value.apply {
                    when {
                        this == null -> {
                            onToast(
                                getString(R.string.label_some_thing_went_wrong),
                                requireContext()
                            )
                        }
                        (this.data ?: arrayListOf()).isEmpty() -> {
                            onToast(
                                getString(R.string.label_some_thing_went_wrong),
                                requireContext()
                            )
