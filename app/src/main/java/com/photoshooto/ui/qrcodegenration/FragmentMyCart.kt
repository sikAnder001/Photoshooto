...
class FragmentMyCart : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener(SelectAddressFragment.REQUEST_ADDRESS_CHANGE) { _, bundle ->
            try {
        ...
        binding.apply {
            ...
            btnAddAddress.setOnClickListener {
                if (requireActivity().isInternetAvailable()) {
                    ...
                    findNavController().safeNavigate(R.id.action_fragmentMyCart_to_photographerManageAddressFragment)
                } else {
                    onToast(getString(R.string.internet_check), requireActivity())
                }
            }
            ...
            if (SharedPrefsHelper.read(SharedPrefConstant.USER_CASE_TYPE) == Constant.USER_CASE_TYPE.PHOTOGRAPHER_CLIENT.name) {
                binding.tvOrderNow.visible()
            } else {
                binding.tvOrderNow.gone()
            }

            tvOrderNow.setOnClickListener {
                findNavController().safeNavigate(R.id.action_fragmentMyCart_to_fragmentQRCodeGenerationStandeeIntro2)
            }
        }
    }
    ...
    private fun showCustomizeShirtDialog() {
        ...
        tvCustomize.setOnClickListener {
            ...
            findNavController().safeNavigate(R.id.action_fragmentMyCart_to_photographerCustomizeShirtFragment)
        }
