...
import com.photoshooto.databinding.FragmentFilterPhotographsBinding
...
class FilterPhotographsFragment : Fragment(), TopPhotographerListAdapter.OnUserItemClickListener {

    private lateinit var binding: FragmentFilterPhotographsBinding
    ...
    var number: String = ""
    var userList: List<UserElement>? = ArrayList()
    ...
    object SORT_BY {
        ...
        const val priceLowToHigh = "price_high_to_low"
        const val priceHighToLow = "price_low_to_high"
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentFilterPhotographsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val filterType = requireArguments().getString("filterType")
        val filter = requireArguments().getString("filter")
        Log.i("filters", "$filterType and $filter")

        binding.tvSelectedLocation.text = filter
        ...
        viewModel.userResponse.observe(requireActivity(), Observer {
            if (it.success!!) {
                ...
                binding.recyclerViewPhotographerList.adapter =
                    TopPhotographerListAdapter(userList, this)
            }
        })
    ...
    fun filter(text: String?) {
        ...
        //update recyclerview
        binding.recyclerViewPhotographerList.adapter =
            TopPhotographerListAdapter(temp, this)
    }
    ...
    override fun onViewProfileClicked(user: UserElement) {
        ...
        findNavController()
            .navigate(
                R.id.action_filterPhotographsFragment_to_photographerDetailFragment,
                bundle
            )
    }
}